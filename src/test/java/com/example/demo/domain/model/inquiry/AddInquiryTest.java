...
public class AddInquiryTest {
    ...
    class Of {
        ...
        void case2() {
            ...
            // 検証
            verify(inquiryAddRequest, actual);
        }
         ...
         */
        private void verify(Inquiry expected, AddInquiry actual) {
         ...
         * @param actual   AddInquiry
         */
        private void verify(InquiryAddRequest expected, AddInquiry actual) {
            Assertions.assertEquals(expected.getName(), actual.getName());
            Assertions.assertEquals(expected.getEmail(), actual.getEmail());
            Assertions.assertEquals(expected.getContents(), actual.getContents());
        }
